...
public class GUIProductsFind extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        txtSearch.setName("txtIdNombre"); // NOI18N
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        if(rdoId.isSelected()){
            ...
            lista.add(productService.findProductById(Long.valueOf(this.txtSearch.getText())));
            fillTable(lista);
        }else if(rdoName.isSelected()){
            fillTable(productService.findProductByName(this.txtSearch.getText()));
        }else{
